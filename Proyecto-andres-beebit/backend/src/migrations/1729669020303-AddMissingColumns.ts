...
export class AddMissingColumns1729669020303 implements MigrationInterface {
    name = 'AddMissingColumns1729669020303'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "empleado" ADD CONSTRAINT "FK_c40582d7d83c3e0e7e240453195" FOREIGN KEY ("empresa_id") REFERENCES "empresa"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
